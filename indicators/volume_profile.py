...
def compute_volume_profile(df: pd.DataFrame, num_bins: int = 50):
    ...
    try:
        ...
        if num_bins < 1:
            ...
            num_bins = 50  # Use default instead of raising error
    ...
    try:
        # ============================================================
        # PRICE RANGE WITH ERROR HANDLING
        # ============================================================
    ...
    try:
        # ============================================================
        # PROPORTIONAL VOLUME DISTRIBUTION WITH ERROR HANDLING
        # ============================================================
    ...
    try:
        # ============================================================
        # HVN / LVN EXTRACTION WITH ERROR HANDLING
        # ============================================================
